```
  ...
  if n < 4 then n times full positional
  if n == 4 then full positional and half positional
  if 5 < n < 9 then half positional and (n - 5) times postional
  if n == 9 then full positional and next full positional
```
